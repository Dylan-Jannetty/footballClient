...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://peaceful-journey-18684.herokuapp.com/',
...
var teamEvents = __webpack_require__(11);
$(function () {
...
var onUpdateTeam = function onUpdateTeam(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateTeam(data).then(ui.updateTeamSuccess).catch(ui.updateTeamFailure);
};

var onDeleteTeam = function onDeleteTeam(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.deleteTeam(data).then(ui.deleteTeamSuccess).then(api.getTeams).catch(ui.deleteTeamFailure);
};
...
var updateTeamSuccess = function updateTeamSuccess(data) {
...
var getTeamsSuccess = function getTeamsSuccess(data) {
  ...
  if (data.teams.length < 1) {
    ...
    data.teams.forEach(function (team) {
      ...
      $('#delete-team-' + team.id).on('submit', function () {
        // Do the delete ajax
      });
    });
    $('#team-message').css('text-align', 'center');
...
var updateTeam = function updateTeam(data) {
  return $.ajax({
